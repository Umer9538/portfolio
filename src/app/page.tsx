  ...
  return (
    <div id="top">
      ...
      <main id="main">
          ...
          <div className="grid items-start gap-10 lg:grid-cols-[58fr_42fr]">
            <div className="min-w-0">
              ...
              <p className="prose-measure mt-6 text-[1.0625rem] leading-[1.7] text-muted">
                ...
                format<E id="e3" />. Alongside: 23 client apps shipped, two acquired by
        ...
        {/* 07 · SHIPPED APPS */}
        <Section id="apps" eyebrow="Section 07 — Shipped apps · 23 delivered · 2 acquired" title="Shipped apps, 2020–2026">
          <Reveal className="mt-6">
            <p className="prose-measure text-[1.0625rem] leading-[1.7] text-muted">
              The client record behind the research: twenty-three production apps
