...
export const REGISTER: RegisterEntry[] = [
  ...
  { id: "e13", no: "E13", claim: "23 client apps shipped 2022–2026; the AI learning platform and maternity-care bot were acquired by investors (built at DriftMeta)", artifact: "app briefs in Section 07 + work history", href: LINKS.linkedin, linkLabel: "LinkedIn" },
];
...
export const CLIENT_APPS: ClientApp[] = [
  { year: "2026", name: "Health Record OCR", cat: "Healthcare / On-Device AI", role: "Flutter Developer", desc: "On-device OCR module for health records — Google ML Kit, fully offline.", full: "Standalone Flutter module built for a maternal-health app (MiGynae): photograph or upload health records and extract text with Google ML Kit on-device OCR — fully offline, records stored locally in SQLite.", features: ["On-device OCR (Google ML Kit)", "Works fully offline", "Camera & gallery capture", "Local SQLite + file storage", "Image compression & validation", "Record retrieval by email"], tech: ["Flutter", "ML Kit", "SQLite"], github: "https://github.com/Umer9538/OCR-MODULE-APP" },
  { year: "2026", name: "Spotwise", cat: "Mobility", role: "Flutter Developer", desc: "Smart parking — spot detection, zone maps, and advance reservations.", full: "Smart parking platform: detects open spots from parking-lot images, organizes zones across a campus, and lets drivers reserve ahead — with history, statistics, and an admin console.", features: ["Parking spot detection from lot images", "Zone & campus maps", "Advance spot reservations", "Parking history & statistics", "Admin management console", "Push notifications"], tech: ["Flutter", "Firebase", "Provider"], github: "https://github.com/Umer9538/Spotwise" },
  { year: "2026", name: "RideSync", cat: "Mobility", role: "Flutter Developer", desc: "Private transport subscriptions — daily commute plans with assigned drivers.", full: "Private transportation subscription app: users subscribe to daily commute plans with assigned drivers, manage schedules, track trips in real time, and pay in-app.", features: ["Daily commute subscription plans", "Assigned personal drivers", "Real-time trip tracking", "Schedule management", "In-app payments", "Cross-platform (Flutter)"], tech: ["Flutter"], github: "https://github.com/Umer9538/Transport-App" },
  { year: "2026", name: "Trendgo", cat: "Social", role: "Flutter Developer", desc: "Social app with stories, marketplace, food ordering, and a restaurant panel.", full: "Social media application combining a feed with stories, an in-app marketplace, food ordering, and a dedicated panel for restaurant owners.", features: ["Social feed & stories", "In-app food ordering", "Marketplace", "Restaurant owner panel", "Customer & owner experiences", "Cross-platform (Flutter)"], tech: ["Flutter"], github: "https://github.com/Umer9538/sngine" },
  { year: "2025", name: "GCC Connect", cat: "Enterprise", role: "Flutter Developer", desc: "Bilingual employee platform for Gulf organizations — full Arabic RTL support.", full: "Cross-platform employee communication and collaboration platform for GCC organizations: meetings and scheduling, role-based permissions, and full English/Arabic support with RTL layouts.", features: ["English + Arabic with full RTL", "Meeting & schedule management", "Role-based access control", "Team communication channels", "Firebase real-time backend", "Cross-platform iOS/Android"], tech: ["Flutter", "Firebase"], github: "https://github.com/Umer9538/gcc" },
  { year: "2025", name: "FinTrack", cat: "FinTech", role: "Flutter Developer", desc: "Personal finance — expense categorization, budgets, bill reminders, analytics.", full: "Personal finance tracker with automatic expense categorization, budgeting, bill reminders, and visual analytics — secure, cloud-synced, and cross-platform.", features: ["Expense categorization", "Budget planning", "Bill reminders", "Visual spending analytics", "Cloud sync", "Secure cross-platform storage"], tech: ["Flutter", "Dart"], github: "https://github.com/Umer9538/fintrack" },
  { year: "2025", name: "SkillBridge", cat: "EdTech / Web", role: "Full Stack Developer", desc: "Web platform connecting learners with real tasks from companies.", full: "Full-stack web platform that connects learners with real-world tasks posted by companies — practical experience that builds a verifiable portfolio.", features: ["Company-posted real tasks", "Learner-task matching", "Portfolio building", "Practical experience tracking", "Full-stack JavaScript", "Responsive web app"], tech: ["JavaScript", "Web"], github: "https://github.com/Umer9538/SkillBridge" },
  { year: "2025", name: "Community Time Bank", cat: "Community", role: "Flutter Developer", desc: "Skill-sharing where services are exchanged for time credits.", full: "Skill-sharing platform where users exchange skills and services using a time-credit system instead of money, built on Firebase.", features: ["Time-credit currency", "Skill & service exchange", "Community profiles", "Service requests", "Firebase backend", "Cross-platform (Flutter)"], tech: ["Flutter", "Firebase"], github: "https://github.com/Umer9538/Community-Time-Bank" },
  { year: "2025", name: "Radio Ads You Missed", cat: "Media / Web", role: "Full Stack Developer", desc: "Replay and discover New Zealand radio ads, promotions, and deals.", full: "Web platform for replaying and discovering New Zealand radio ads, promotions, and deals listeners may have missed on air.", features: ["Radio ad replay", "Deal & promotion discovery", "NZ radio coverage", "Search & browse", "TypeScript web app", "Listener-first design"], tech: ["TypeScript", "Web"], github: "https://github.com/Umer9538/Radio_Ads_you_Missed" },
