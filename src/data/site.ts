...
export const REGISTER: RegisterEntry[] = [
  ...
  { id: "e13", no: "E13", claim: "17 client apps shipped 2022–2026; the AI learning platform and maternity-care bot were acquired by investors (built at DriftMeta)", artifact: "app briefs in Section 07 + work history", href: LINKS.linkedin, linkLabel: "LinkedIn" },
];
